...
import { jsExtensions, extensionsRuleAssigner } from '@/utils/extensionsPattern';
 ...
 * Config
 */
const importsXBaseRules = {
  name: 'eslint-config/rules/imports/imports-x-base',
  languageOptions: {
    globals: {
      ...globals.es2015,
    },
  ...
  settings: {
    // TODO: needs to append configuration by API document
    'import-x/resolver-next': [
      plugin.createNodeResolver({ extensions: [...jsExtensions, '.json'] }),
    ],
...
export default importsXBaseRules;
