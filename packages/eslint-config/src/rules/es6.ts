...
const es6Rules = {
  ...
  rules: {
    ...
    // https://eslint.nodejs.cn/docs/latest/rules/prefer-arrow-callback#rule-details
    // NOTE
    ...
    // https://eslint.nodejs.cn/docs/latest/rules/prefer-destructuring#rule-details
    // NOTE
